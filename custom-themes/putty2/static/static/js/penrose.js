...
class ConvexPolygon {
  constructor(p3 = null, p4 = null, N = 4, C = 50) {
    this.p3 = p3 || randomPoint();
    this.p4 = p4 || randomPoint();
...
$(document).ready(function () {
  const wrapper = $("canvas")[0];
  const penroseScene = new Pencil.Scene(wrapper);

  const poly = new ConvexPolygon();
  ...
  const rect = new Pencil.Polygon(penroseScene.center, points, options);
  penroseScene.add(rect);
